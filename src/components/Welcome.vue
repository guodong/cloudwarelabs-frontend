          ...
          <nav class="navbar navbar-default">
            <div class="container-fluid">
              <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">Cloudware Lab</a>
              </div>
        ...
        <div class="container" style="padding-top: 120px">
          ...
          <div class="row" style="margin-top: 50px">
            <div class="col-xs-4 col-sm-3">
              <div class="block">
                <img src="../assets/welcome/matlab.jpeg">
                <p>MATLAB</p>
              </div>
            </div>
            <div class="col-xs-4 col-sm-3">
            ...
            <div class="col-xs-4 col-sm-3">
              <div class="block">
                <img src="../assets/welcome/eclipse.png">
                <p>ECLIPSE</p>
              </div>
            </div>
            <div class="col-xs-4 col-sm-3">
              <div class="block">
                <img src="../assets/welcome/netbeans.png">
                <p>NETBEANS</p>
              </div>
            </div>
            <div class="col-xs-4 col-sm-3">
              <div class="block">
                <img src="../assets/welcome/terminal.ico">
                <p>终端操作</p>
              </div>
            </div>
            <div class="col-xs-4 col-sm-3">
            ...
            <div class="col-xs-4 col-sm-3">
              <div class="block">
                <img src="../assets/welcome/file.jpeg">
                <p>文件管理</p>
              </div>
            </div>
            <div class="col-xs-4 col-sm-3">
              <div class="block">
                <img src="../assets/welcome/games.png">
                <p>在线游戏</p>
              </div>
            </div>
